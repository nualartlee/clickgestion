...
class ServiceType(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = gettext_lazy('Service Types')
...
class Service(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = gettext_lazy('Service')
...
class ServiceSaleSettings(ConceptSettings):
    """
    Service Sale Concept Settings
    """
    class Meta:
        verbose_name = gettext_lazy('Service Sale Settings')
        verbose_name_plural = gettext_lazy('Service Sale Settings')


class ServiceSale(BaseConcept):
    """
    Transaction Concept
    Service sale
    """
    ...
    _url = '/service-sales/{}'
    _code_initials = 'SS'
    _concept_class = 'servicesale'
    _settings_class = ServiceSaleSettings
    _verbose_name = 'Service Sale'

    class Meta:
        verbose_name = pgettext_lazy('Concept name', 'Service Sale')
        verbose_name_plural = pgettext_lazy('Concept name plural', 'Service Sales')
    ...
    def description_short(self):
        desc = '{} {}: {}'.format(self.name, self.service.servicetype.name, self.service.name)
        # Date required
