...
class ModelCreationTest(CustomTestCase):
    ...
    def test_create_one_of_each(self):
        ...
        parkingrental = model_creation.create_test_parkingrental(transaction, timezone.now())
        parkingrentaldeposit = model_creation.create_test_parkingrentaldeposit(transaction, aptrental, timezone.now())
