...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Safe Rental',
                'verbose_name_plural': 'Safe Rentals',
            },
            bases=('concepts.baseconcept',),
        ),
        migrations.CreateModel(
            name='SafeRentalSettings',
            fields=[
            ...
            options={
                'verbose_name': 'Safe Rental Settings',
                'verbose_name_plural': 'Safe Rental Settings',
            },
        ),
    ]
