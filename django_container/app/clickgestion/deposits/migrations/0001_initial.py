    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max', models.DecimalField(decimal_places=2, default=300, max_digits=12, verbose_name='Maximum Amount')),
                ('min', models.DecimalField(decimal_places=2, default=50, max_digits=12, verbose_name='Minimum Amount')),
                ('per_adult', models.DecimalField(decimal_places=2, default=10, max_digits=12, verbose_name='Amount Per Adult/Night')),
                ('per_child', models.DecimalField(decimal_places=2, default=5, max_digits=12, verbose_name='Amount Per Child/Night')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseconcept_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='concepts.BaseConcept')),
                ('amount', models.DecimalField(decimal_places=2, default=10, max_digits=12, verbose_name='Amount')),
            ],
            options={
