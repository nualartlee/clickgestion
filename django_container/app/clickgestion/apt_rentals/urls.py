...
urlpatterns = [
    ...
    url(r'^deposits/new/(?P<transaction_code>T[A-F0-9]{10})$', concept_edit, {'concept_form': AptRentalDepositForm},
        name='deposit_new'),
    url(r'^deposits/(?P<concept_code>T[A-F0-9]{10}-[A-Z0-9]+)$', concept_detail, {'concept_form': AptRentalDepositForm},
        name='deposit_detail'),
    url(r'^deposits/(?P<concept_code>T[A-F0-9]{10}-[A-Z0-9]+)/edit/$', concept_edit, {'concept_form': AptRentalDepositForm},
        name='deposit_edit'),
    url(r'^deposits/(?P<concept_code>T[A-F0-9]{10}-[A-Z0-9]+)/delete/$', concept_delete, {'concept_form': AptRentalDepositForm},
        name='deposit_delete'),
]
