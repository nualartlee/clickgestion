    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rates', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(), size=None, verbose_name='Array Of Rates')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monday', models.FloatField(verbose_name='Monday')),
                ('tuesday', models.FloatField(verbose_name='Tuesday')),
                ('wednesday', models.FloatField(verbose_name='Wednesday')),
                ('thursday', models.FloatField(verbose_name='Thursday')),
                ('friday', models.FloatField(verbose_name='Friday')),
                ('saturday', models.FloatField(verbose_name='Saturday')),
                ('sunday', models.FloatField(verbose_name='Sunday')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated')),
            ],
            options={
