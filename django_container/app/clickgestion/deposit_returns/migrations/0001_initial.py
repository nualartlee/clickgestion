# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2019-03-10 23:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('returned_deposit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deposit_return', to='transactions.BaseConcept', verbose_name='Returned Deposit')),
            ],
            options={
                'verbose_name': 'Deposit Return',
                'verbose_name_plural': 'Deposit Return',
            },
